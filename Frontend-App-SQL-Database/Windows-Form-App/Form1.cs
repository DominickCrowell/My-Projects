...
namespace B321_Final_Project_.NET
{
    public partial class frmMain : Form
    {
        ...
        } // end method button7_Click

        #region Refresh Buttons WIP
        ...
        private void btnSaveChanges_eep_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    if (rowsAffected > 0)
                    {
                        MessageBox.Show("The entry for " + txtFirstName_anp.Text + " " + txtLastName_anp.Text + " was Updated succsessfully!");
                    } // end if
                    else
                    {
                        MessageBox.Show("No changes were made to the person.");
                    } // end else
                } // end try
                catch (Exception)
                {
        ...
        private void btnSaveChanges_eee_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    if (rowsAffected > 0)
                    {
                        MessageBox.Show("The entry for " + txtName_eee.Text + " was Updated succsessfully!");
                    } // end if
                    else
                    {
                        MessageBox.Show("No changes were made to the person.");
